...
fetch(baseURL + '/data/groupgroupten')
    .then((res) => res.json())
    .then((data) => {
        groupData["timedate"] = data["timedate"];
    });
...
function converttime() {
    ...
    console.log(groupData)
        ...
        fetch(baseURL + '/data/groupgroupten/timedate')
            .then(res => res.json())
            .then(data => groupData.timedate = data)
            .catch(console.log)
        ...
        if (groupData["sleeptime"] == 0) {
            ...
            console.log(groupData['wakeuptime']);
